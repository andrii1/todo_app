...
task1 = Task.new(title: 'Buy milk', description: '1.5% milk', status: false, due_date:"2024-12-20")
task2 = Task.new(title: 'Buy bread', description: 'Dark bread', status: false, due_date:"2024-12-21")
task3 = Task.new(title: 'Buy water', description: '1L of water', status: false, due_date:"2024-12-22")
puts 'tasks created'
